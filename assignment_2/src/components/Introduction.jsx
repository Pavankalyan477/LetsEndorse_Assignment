...
export default function Introduction() {
  ...
  const Establish_Age = () => {
    ...
    if (Number(age_of_establishment) !== 0) {
      setAge(
        `This enterprise has been operational since ${age_of_establishment} years and has been serving its customers since then.`
      );
    } else {
      setAge("");
    }
  ...
  const Products = () => {
    let primary_product_service_offered =
      document.getElementById("Product").value;
    let offered_to = document.getElementById("offered_to").value;
    setProduct(
      `This establishment offers products/services like- ${primary_product_service_offered} to ${offered_to}.`
    );
  };
  const Servies = () => {
    let secondary_product_service_offered = document.getElementById(
  ...
  const Processed = () => {
    let processed_products =
      document.getElementById("processed_products").value;
  ...
  const Relevant = () => {
    let relevant_experience = document.getElementById(
      "relevant_experience"
    ).value;
  ...
  return (
    <div className="total">
      <div className="content">
        <Skeleton variant="h1"> Fill Introduction Details Below </Skeleton>
        <div>
          <div className="Data">
            1.Stage of business :-
        ...
        <div>
          <div className="Data">
            ...
            <input
              type="Text"
              placeholder="Processed_Products"
              id="processed_products"
              onChange={Processed}
            />
          </div>
          <p></p>
        ...
        <Container maxWidth="sm">
          <Box>
            <div>
              <h2>Introduction</h2>
              <li>
                {businesss} {age} {product} {servies} {processed} {relevant}{" "}
                {skill} {usp}
              </li>
            </div>
          </Box>
